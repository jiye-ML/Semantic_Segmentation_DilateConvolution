...
if __name__ == "__main__":
    ...
    dilated_conv = DilatedConvolution("camvid", cam_vid_data, learning_rate=1e-6)
    runner = Runner(data=cam_vid_data, net=dilated_conv, model_path=dilated_conv.checkpoint, result_path=Tools.new_dir("result"))
